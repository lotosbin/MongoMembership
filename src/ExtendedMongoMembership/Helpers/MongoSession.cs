...
namespace ExtendedMongoMembership
{
    ...
    public class MongoSession
    {
        ...
        public IQueryable<MembershipPermission> Permissions
        {
            get { return _provider.GetCollection<MembershipPermission>("Permissions").AsQueryable(); }
        }
        ...
        private string GetCollectionName<T>()
        {
            ...
            else if (t == typeof(MembershipPermission))
            {
                result = "Permissions";
            }
